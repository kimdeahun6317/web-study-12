...
<body>
	<div id="wrap" align="center">
		...
		<form name="frm" method="post" action="boardWrite.do">
			<input type="hidden" name="command" value="boardWrite.do">
			<table>
				<tr>
					<th>작성자</th>
				...
				<tr>
					<th>비밀번호</th>
					<td><input type="password" name="pass" id="pass">* 필수(게시물 수정 삭제시
						필요합니다)</td>
				</tr>
				<tr>
					<th>이메일</th>
			...
			<br> <input type="submit" value="등록"
				onclick="return boardCheck()" id="add"> <input type="reset"
				value="다시 작성"> <input type="button" value="목록"
				onclick="loaction.href='boardList.do'" id="list">
		</form>
	</div>
</body>
</html>